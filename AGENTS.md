...
- `src/openaugi/agents/task_watcher.py` — Task files → tmux Codex sessions
- `src/openaugi/mcp/server.py` — MCP tools for Codex
...
Docs should follow Codex skill format - name: and description: at the top that we can scan the top only to find relevant docs.
